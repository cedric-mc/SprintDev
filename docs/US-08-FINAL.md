...
- [x] La couverture des routes API atteint au moins 70 % selon le rapport Jest : 92,85 % des instructions des routes et 93,08 % des lignes au niveau global.
...
- [x] Résultat actuel : 14 tests passants, lint vert, 92,78 % d’instructions et 93,08 % de lignes couvertes globalement.
