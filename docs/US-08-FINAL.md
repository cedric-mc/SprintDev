...
- [x] La couverture des routes API atteint au moins 70 % selon le rapport Jest : 88,46 % des instructions et 92,30 % des lignes au niveau global.
...
- [x] Résultat actuel : 21 tests passants, lint vert, 88,46 % d’instructions et 92,30 % de lignes couvertes globalement.
