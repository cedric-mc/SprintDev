...
- [x] La couverture des routes API atteint au moins 70 % selon le rapport Jest : 89,11 % des instructions et 92,76 % des lignes au niveau global.
...
- [x] Tests API : health check, mairies, signalements, création valide, validations invalides, changement de statut, suppression, admin et debug.
- [x] Résultat actuel : 23 tests d’intégration passants avec Supertest, lint vert, 89,11 % d’instructions et 92,76 % de lignes couvertes globalement.
